...
const Contact = () => {
  ...
  <div className="min-h-screen w-full relative overflow-hidden py-10">
    <div
      className={`fixed top-0 left-0 w-full h-screen -z-10 bg-[url('/images/gallery/grp7.jpg')] bg-cover bg-center transition-opacity duration-500 ${
        showBallBg ? "opacity-0" : "opacity-100"
      }`}
    ></div>

    <div className="relative text-4xl md:text-8xl h-96 flex justify-center items-center text-center text-white">
      Contact US
    </div>

    {/* Content Container */}
    <div className="relative z-10 flex flex-col md:flex-row items-center justify-between min-h-screen p-4 md:p-8 max-w-7xl mx-auto">
      {/* Left Section: Keep in Touch */}
      <div className="w-full md:w-1/2 pr-0 md:pr-8 p-4 md:p-9 -mx-3 bg-white rounded-2xl mb-8 md:mb-0">
        <h1 className="text-2xl md:text-4xl font-bold text-black mb-6">Keep in Touch</h1>
        <p className="text-red text-base md:text-lg mb-4">
      ...
      <div className="w-full md:w-1/2 bg-white rounded-lg shadow-lg p-4 md:p-8">
        <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-6">Send us your Requirements</h2>
    ...
    <div
      className={`fixed top-0 left-0 w-full h-screen -z-10 bg-[url('/images/gallery/grp0.jpg')] bg-cover bg-center transition-opacity duration-200 ${
        showBallBg ? "opacity-100" : "opacity-0"
      }`}
    ></div>

    <div
      className="relative text-4xl md:text-8xl h-96 flex justify-center items-center text-center text text-white font-headline"
      id="helloSection"
    >
        ...
        <div className="bg-white w-full md:w-auto rounded-lg shadow-lg p-4 md:p-6 inline-block">
          <h1 className='flex flex-col md:flex-row items-center justify-center'>
            ...
            <a
              ...
              className="block text-base md:text-lg text-blue-500 hover:text-blue-700 mb-4 md:mb-0 md:ml-2"
            >
              +91 7972351030
            </a>
          </h1>
          ...
          <h1 className='flex flex-col md:flex-row items-center justify-center'>
            ...
            <a
              ...
              className="block text-base md:text-lg text-blue-500 hover:text-blue-700 md:ml-2"
            >
        ...
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="w-full md:w-1/2 flex items-center justify-center">
            <div className="text-center md:text-left">
              <h2 className="text-xl md:text-2xl font-bold text-gray-800 mb-4">Our Address</h2>
